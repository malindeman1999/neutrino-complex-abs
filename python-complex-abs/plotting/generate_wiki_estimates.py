...
def main() -> None:
    ...
    symbols = {
        ...
        "Tc_K": r"\(T_c\)",
        "pg_drive_dBm": r"\(P_{g,\mathrm{dBm}}\)",
        "heater_drive_dBm": r"\(P_{\mathrm{heater,dBm}}\)",
        "R0_Ohm": r"\(R_0\)",
        "P0_W": r"\(P_0\)",
        "Pg_W": r"\(P_g\)",
        "P_heater_W": r"\(P_{\mathrm{heater}}\)",
        "P_island_total_W": r"\(P_{\mathrm{island,tot}}\)",
    ...
    formulas = {
        ...
        "G_W_per_K": r"\(G=\dfrac{P_0+P_{\mathrm{heater}}}{\Delta T_{\mathrm{abs-bath,set}}}\)",
        ...
        "Pg_W": r"\(P_g=10^{-3}\,10^{(\mathrm{pg\_drive\_dBm}/10)}\)",
        "P_heater_W": r"\(P_{\mathrm{heater}}=10^{-3}\,10^{(\mathrm{heater\_drive\_dBm}/10)}\)",
        "P_island_total_W": r"\(P_{\mathrm{island,tot}}=P_0+P_{\mathrm{heater}}\)",
    ...
    formula_dependencies = {
        ...
        "G_W_per_K": {"P0_W", "P_heater_W", "deltaT_abs_over_bath_setpoint_K"},
        ...
        "Pg_W": {"pg_drive_dBm"},
        "P_heater_W": {"heater_drive_dBm"},
        "P_island_total_W": {"P0_W", "P_heater_W"},
